...
public class ArticleAdapter extends GroupRecyclerAdapter<String, edu.zjut.androiddeveloper_ailaiziciqi.Calendar.Article> {
    ...
    public ArticleAdapter(Context context) {
        ...
        LinkedHashMap<String, List<edu.zjut.androiddeveloper_ailaiziciqi.Calendar.Article>> map = new LinkedHashMap<>();
    ...
    @Override
    protected void onBindViewHolder(RecyclerView.ViewHolder holder, edu.zjut.androiddeveloper_ailaiziciqi.Calendar.Article item, int position) {
