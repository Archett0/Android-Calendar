...
public final class MonthViewPager extends ViewPager {
    ...
    edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarLayout mParentLayout;

    WeekViewPager mWeekPager;

    edu.zjut.androiddeveloper_ailaiziciqi.calendarview.WeekBar mWeekBar;
     ...
     */
    void setup(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate delegate) {
    ...
    private void init() {
        ...
        addOnPageChangeListener(new OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getFirstCalendarFromMonthViewPager(position, mDelegate);
                ...
                if (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT) {
                    if (!calendar.isCurrentMonth()) {
                        ...
                        mDelegate.mSelectedCalendar = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getRangeEdgeCalendar(calendar, mDelegate);
                    }
                ...
                if (!isUsingScrollToCalendar && mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT) {
                ...
                edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseMonthView view = findViewWithTag(position);
                if (view != null) {
    ...
    private void updateMonthViewHeight(int year, int month) {
        if (mDelegate.getMonthViewShowMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ALL_MONTH) {//非动态高度就不需要了
        ...
        if (mParentLayout != null) {
            if (getVisibility() != VISIBLE) {//如果已经显示周视图，则需要动态改变月视图高度，否则显示就有bug
                ViewGroup.LayoutParams params = getLayoutParams();
                params.height = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year, month,
        ...
        mCurrentViewHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year, month,
                mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                mDelegate.getMonthViewShowMode());
        if (month == 1) {
            mPreViewHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year - 1, 12,
                    mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                    mDelegate.getMonthViewShowMode());
            mNextViewHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year, 2,
                    mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                    mDelegate.getMonthViewShowMode());
        } else {
            mPreViewHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year, month - 1,
                    mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                    mDelegate.getMonthViewShowMode());
            if (month == 12) {
                mNextViewHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year + 1, 1,
                        mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                        mDelegate.getMonthViewShowMode());
            } else {
                mNextViewHeight = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getMonthViewHeight(year, month + 1,
                        mDelegate.getCalendarItemHeight(), mDelegate.getWeekStart(),
                        mDelegate.getMonthViewShowMode());
            }
        }
    ...
    final void updateRange() {
        ...
        isUsingScrollToCalendar = false;
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar = mDelegate.mSelectedCalendar;
        ...
        if (mParentLayout != null) {
            int week = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getWeekFromDayInMonth(calendar, mDelegate.getWeekStart());
    ...
    void scrollToCalendar(int year, int month, int day, boolean smoothScroll, boolean invokeListener) {
        ...
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.LunarCalendar.setupLunarCalendar(calendar);
        mDelegate.mIndexCalendar = calendar;
        mDelegate.mSelectedCalendar = calendar;
        mDelegate.updateSelectCalendarScheme();
        int y = calendar.getYear() - mDelegate.getMinYear();
     ...
     * @return 获取当前月份数据
     */
    List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> getCurrentMonthCalendars() {
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseMonthView view = findViewWithTag(getCurrentItem());
        if (view == null) {
            return null;
        }
        return view.mItems;
    ...
    void updateSelected() {
        for (int i = 0; i < getChildCount(); i++) {
            edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseMonthView view = (edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseMonthView) getChildAt(i);
    ...
    void updateWeekStart() {
        ...
        setLayoutParams(params);
        if (mParentLayout != null) {
            int i = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getWeekFromDayInMonth(mDelegate.mSelectedCalendar, mDelegate.getWeekStart());
    ...
    private final class MonthViewPagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseMonthView view;
            try {
                Constructor constructor = mDelegate.getMonthViewClass().getConstructor(Context.class);
                view = (edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseMonthView) constructor.newInstance(getContext());
            } catch (Exception e) {
                e.printStackTrace();
                return new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.DefaultMonthView(getContext());
            }
        ...
        public void destroyItem(@NonNull ViewGroup container, int position, @NonNull Object object) {
            edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseView view = (edu.zjut.androiddeveloper_ailaiziciqi.calendarview.BaseView) object;
            view.onDestroy();
