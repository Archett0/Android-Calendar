...
public final class CalendarUtil {
     ...
     */
    public static boolean isWeekend(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
    ...
    public static int getMonthViewLineCount(int year, int month, int weekStartWith, int mode) {
        if (mode == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ALL_MONTH) {
            return 6;
        }
     ...
     */
    public static int getWeekFromDayInMonth(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 获取上一个日子
     */
    public static edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar getPreCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar preCalendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
    ...
    public static edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar getNextCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar nextCalendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
     ...
     */
    static int getMonthViewStartDiff(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        date.set(calendar.getYear(), calendar.getMonth() - 1, 1, 12, 0, 0);
        int week = date.get(java.util.Calendar.DAY_OF_WEEK);
        if (weekStart == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SUN) {
            return week - 1;
        }
        if (weekStart == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_MON) {
            return week == 1 ? 6 : week - weekStart;
        }
        return week == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SAT ? 0 : week;
    }
     ...
     * @return 返回某个日期是星期几
     */
    static int getWeekFormCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     */
    static int getWeekViewIndexFromCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int weekStart) {
     ...
     * @return 是否在日期范围內
     */
    static boolean isCalendarInRange(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar,
     ...
     */
    public static int getWeekFromCalendarStartWithMinCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar,
                                                              int minYear, int minYearMonth, int minYearDay,
                                                              int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     * @return 该星期的第一天日期
     */
    public static edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar getFirstCalendarStartWithMinCalendar(int minYear, int minYearMonth, int minYearDay, int week, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
     ...
     * @return 是否在日期范围内
     */
    static boolean isCalendarInRange(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate delegate) {
     ...
     */
    public static int differ(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar1, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar2) {
        if (calendar1 == null) {
    ...
    public static int compareTo(int minYear, int minYearMonth, int minYearDay,
                                int maxYear, int maxYearMonth, int maxYearDay) {
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar first = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
        first.setYear(minYear);
        first.setMonth(minYearMonth);
        first.setDay(minYearDay);

        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar second = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
     ...
     * @return 为月视图初始化日历项
     */
    static List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> initCalendarForMonthView(int year, int month, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar currentDate, int weekStar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
        ...
        List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> mItems = new ArrayList<>();
        ...
        for (int i = 0; i < size; i++) {
            edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendarDate = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
            if (i < mPreDiff) {
    ...
    static List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> getWeekCalendars(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate mDelegate) {
        ...
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar startCalendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
    ...
    static List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> initCalendarForWeekView(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate mDelegate, int weekStart) {
        ...
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar selectCalendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
     ...
     */
    static edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar getFirstCalendarFromMonthViewPager(int position, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate delegate) {
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
        ...
        if (delegate.getDefaultCalendarSelectDay() != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.FIRST_DAY_OF_MONTH) {
            int monthDays = getMonthDaysCount(calendar.getYear(), calendar.getMonth());
            edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar indexCalendar = delegate.mIndexCalendar;
     ...
     * @return 获取边界访问日期
     */
    static edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar getRangeEdgeCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate delegate) {
        if (CalendarUtil.isCalendarInRange(delegate.getCurrentDay(), delegate)
                && delegate.getDefaultCalendarSelectDay() != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.LAST_MONTH_VIEW_SELECT_DAY_IGNORE_CURRENT) {
            return delegate.createCurrentDate();
        }
        if (isCalendarInRange(calendar, delegate)) {
            return calendar;
        }
        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar minRangeCalendar = delegate.getMinRangeCalendar();
     ...
     * @return 是否是最小访问边界了
     */
    private static boolean isMinRangeEdge(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate delegate) {
        java.util.Calendar c = java.util.Calendar.getInstance();
