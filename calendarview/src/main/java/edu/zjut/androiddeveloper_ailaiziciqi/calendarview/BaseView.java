...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
     ...
     * 日历项
     */
    protected List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> mItems;
     ...
     */
    protected boolean isSelected(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
     ...
     * @return 是否拦截日期
     */
    protected final boolean onCalendarIntercept(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
     ...
     * @return 是否在日期范围内
     */
    protected final boolean isInRange(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
    ...
    protected int getWeekStartWith() {
        return mDelegate != null ? mDelegate.getWeekStart() : edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SUN;
    }
