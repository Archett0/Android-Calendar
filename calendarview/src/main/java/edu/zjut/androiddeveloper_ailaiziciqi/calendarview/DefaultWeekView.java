...
public final class DefaultWeekView extends edu.zjut.androiddeveloper_ailaiziciqi.calendarview.WeekView {
     ...
     */
    @Override
    protected boolean onDrawSelected(Canvas canvas, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int x, boolean hasScheme) {
    ...
    @Override
    protected void onDrawScheme(Canvas canvas, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int x) {
    ...
    @Override
    protected void onDrawText(Canvas canvas, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int x, boolean hasScheme, boolean isSelected) {
