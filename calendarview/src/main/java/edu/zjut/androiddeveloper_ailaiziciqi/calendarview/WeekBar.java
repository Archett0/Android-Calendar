...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("edu.zjut.androiddeveloper_ailaiziciqi.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate delegate) {
        ...
        if ("edu.zjut.androiddeveloper_ailaiziciqi.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
     ...
     */
    protected void onDateSelected(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int weekStart, boolean isClick) {
     ...
     */
    protected int getViewIndexByCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int weekStart) {
        ...
        if (weekStart == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_MON) {
            return week == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SUN ? 6 : week - 2;
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        if (mDelegate != null) {
            ...
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(getContext(), 40), MeasureSpec.EXACTLY);
        }
