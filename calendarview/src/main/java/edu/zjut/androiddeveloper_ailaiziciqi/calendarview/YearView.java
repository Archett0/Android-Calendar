...
public abstract class YearView extends View {
    ...
    edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate mDelegate;
     ...
     * 日历项
     */
    List<edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar> mItems;
    ...
    private void addSchemesFromMap() {
        ...
        for (edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar a : mItems) {
            if (mDelegate.mSchemeDatesMap.containsKey(a.toString())) {
                edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar d = mDelegate.mSchemeDatesMap.get(a.toString());
                if(d == null){
                    continue;
                }
     ...
     * @param d        d
     */
    private void draw(Canvas canvas, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int i, int j, int d) {
     ...
     * @param y        日历Card y起点坐标
     */
    protected abstract void onDrawScheme(Canvas canvas, edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar, int x, int y);
