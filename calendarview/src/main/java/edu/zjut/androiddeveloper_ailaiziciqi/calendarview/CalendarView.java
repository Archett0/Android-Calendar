...
public class CalendarView extends FrameLayout {
     ...
     * 抽取自定义属性
     */
    private final edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate mDelegate;
    ...
    public CalendarView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        mDelegate = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate(context, attrs);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mDelegate.mInnerListener = new OnInnerDateSelectedListener() {
            ...
            public void onMonthDateSelected(Calendar calendar, boolean isClick) {
                ...
                if (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick) {
                    mDelegate.mSelectedCalendar = calendar;
                }
                mWeekPager.updateSelected(mDelegate.mIndexCalendar, false);
                mMonthPager.updateSelected();
                if (mWeekBar != null &&
                        (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT || isClick)) {
            ...
            public void onWeekDateSelected(Calendar calendar, boolean isClick) {
                ...
                mMonthPager.updateSelected();
                if (mWeekBar != null &&
                        (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT
                                || isClick
                                || mDelegate.mIndexCalendar.equals(mDelegate.mSelectedCalendar))) {
                    mWeekBar.onDateSelected(calendar, mDelegate.getWeekStart(), isClick);
                }
        ...
        if (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT) {
    ...
    private void closeSelectLayout(final int position) {
        ...
        if (position == mMonthPager.getCurrentItem()) {
            if (mDelegate.mCalendarSelectListener != null &&
                    mDelegate.getSelectMode() != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_SINGLE) {
    ...
    public final void setDefaultMonthViewSelectDay() {
        mDelegate.setDefaultCalendarSelectDay(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.FIRST_DAY_OF_MONTH);
    }

    public final void setLastMonthViewSelectDay() {
        mDelegate.setDefaultCalendarSelectDay(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.LAST_MONTH_VIEW_SELECT_DAY);
    }

    public final void setLastMonthViewSelectDayIgnoreCurrent() {
        mDelegate.setDefaultCalendarSelectDay(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.LAST_MONTH_VIEW_SELECT_DAY_IGNORE_CURRENT);
    }
    ...
    public final void setOnCalendarInterceptListener(OnCalendarInterceptListener listener) {
        ...
        if (listener == null || mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT) {
            return;
        }
    ...
    public final void setSelectStartCalendar(int startYear, int startMonth, int startDay) {
        if (mDelegate.getSelectMode() != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_RANGE) {
            return;
        }
    ...
    public final void setSelectDefaultMode() {
        ...
        mDelegate.setSelectMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_DEFAULT);
        mWeekBar.onDateSelected(mDelegate.mSelectedCalendar, mDelegate.getWeekStart(), false);
    ...
    public void setSelectRangeMode() {
        ...
        mDelegate.setSelectMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_RANGE);
        clearSelectRange();
    }
    ...
    public void setSelectMultiMode() {
        if (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_MULTI) {
            return;
        }
        mDelegate.setSelectMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_MULTI);
        clearMultiSelect();
    }
    ...
    public void setSelectSingleMode() {
        if (mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_SINGLE) {
            return;
        }
        mDelegate.setSelectMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_SINGLE);
    ...
    public void setWeekStarWithSun() {
        setWeekStart(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SUN);
    }
    ...
    public void setWeekStarWithMon() {
        setWeekStart(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_MON);
    }
    ...
    public void setWeekStarWithSat() {
        setWeekStart(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SAT);
    }
    ...
    private void setWeekStart(int weekStart) {
        if (weekStart != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SUN &&
                weekStart != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_MON &&
                weekStart != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.WEEK_START_WITH_SAT)
            return;
    ...
    public boolean isSingleSelectMode() {
        return mDelegate.getSelectMode() == edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.SELECT_MODE_SINGLE;
    }
    ...
    public void setAllMode() {
        setShowMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ALL_MONTH);
    }
    ...
    public void setOnlyCurrentMode() {
        setShowMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ONLY_CURRENT_MONTH);
    }
    ...
    public void setFixMode() {
        setShowMode(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_FIT_MONTH);
    }
    ...
    private void setShowMode(int mode) {
        if (mode != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ALL_MONTH &&
                mode != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_ONLY_CURRENT_MONTH &&
                mode != edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MODE_FIT_MONTH)
            return;
