...
public final class DefaultMonthView extends MonthView {
    ...
    public DefaultMonthView(Context context) {
        ...
        mTextPaint.setTextSize(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(context, 8));
        ...
        mRadio = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(getContext(), 7);
        mPadding = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(getContext(), 4);
        Paint.FontMetrics metrics = mSchemeBasicPaint.getFontMetrics();
        mSchemeBaseLine = mRadio - metrics.descent + (metrics.bottom - metrics.top) / 2 + edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.dipToPx(getContext(), 1);
