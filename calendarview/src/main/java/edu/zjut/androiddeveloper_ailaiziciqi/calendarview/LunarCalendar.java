...
public final class LunarCalendar {
    ...
    public static int daysInLunarMonth(int year, int month) {
        if ((LUNAR_INFO[year - edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarViewDelegate.MIN_YEAR] & (0x10000 >> month)) == 0)
            return 29;
        else
            return 30;
    }
    ...
    public static String getLunarText(int year, int month, int day) {
        ...
        if (!TextUtils.isEmpty(termText))
            return termText;
        int[] lunar = edu.zjut.androiddeveloper_ailaiziciqi.calendarview.LunarUtil.solarToLunar(year, month, day);
     ...
     */
    public static void setupLunarCalendar(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
        int year = calendar.getYear();
        int month = calendar.getMonth();
        int day = calendar.getDay();
        calendar.setWeekend(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.isWeekend(calendar));
        calendar.setWeek(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.getWeekFormCalendar(calendar));

        edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar lunarCalendar = new edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar();
        ...
        calendar.setLeapYear(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.CalendarUtil.isLeapYear(year));
        if (lunar[3] == 1) {//如果是闰月
     ...
     * @return 获取农历节日
     */
    public static String getLunarText(edu.zjut.androiddeveloper_ailaiziciqi.calendarview.Calendar calendar) {
